<script lang="ts">
  ...
  <div class="info-item-editavel">
    ...
    {#if !editando}
      <div class="display-container">
        ...
        <button class="btn-edit" on:click={ativarEdicao} title="Editar" {disabled}>
    ...
    {:else}
      <div class="edit-container">
        <input type="text" bind:value={valorEditavel} class="input-edit" on:keydown={(e) => e.key === 'Enter' && salvar()} on:keydown={(e) => e.key === 'Escape' && cancelar()} />
  ...
  <style>
    ...
    .btn-save:hover { color: #4CAF50; }
    .btn-cancel:hover { color: #F44336; }
    .input-edit {
      flex-grow: 1;
      background: #fff;
